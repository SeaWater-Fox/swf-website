...
<html lang="en">
  <head>
    ...
    <title>SeaWater Fox</title>

    <!-- Bootstrap core CSS -->
    <link href="./css/bootstrap.min.css?ver=1" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="./css/cover.css?ver=1.1" rel="stylesheet">
  ...
  <body>
      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
          ...
          <div class="masthead clearfix">
            <div class="inner">
              <h3 class="masthead-brand">SeaWater Fox</h3>
              <nav>
    ...
    <div id="openModal" class="modalDialog">
      <div>
        ...
        <h2 style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif">Subscribe to Our Mailing List</h2>
        <!-- Begin MailChimp Signup Form -->
        <link href="//cdn-images.mailchimp.com/embedcode/classic-081711.css" rel="stylesheet" type="text/css">
        <style type="text/css">
          #mc_embed_signup{clear:left; font:14px "Helvetica Neue",Helvetica,Arial,sans-serif; }
          #mc-embedded-subscribe{background-color:#000 !important;}
        ...
        <form action="//seawaterfox.us10.list-manage.com/subscribe/post?u=984d3ee8dc5cd7123018f9293&amp;id=7a9fe3fea3" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate="">
          <div id="mc_embed_signup_scroll">
            ...
            <div style="position: absolute; left: -5000px;"><input type="text" name="b_984d3ee8dc5cd7123018f9293_7a9fe3fea3" tabindex="-1" value=""></div>
